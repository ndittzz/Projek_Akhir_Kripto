...
<html lang="en">
  ...
  <body class="sb-nav-fixed">
                    ...
                    <tr>
                        ...
                        <td>
                             <a href="javascript:void(0);" 
                                onclick="decryptWithKey(<?= $row['id_pegawai']; ?>)" 
                                class="btn btn-sm btn-warning">Decrypt
                            </a>
    ...
    <script src="../js/scripts.js"></script>
    <script>
    function decryptWithKey(idPegawai) {
        const userKey = prompt("Masukkan kunci untuk dekripsi:");
        if (userKey) {
            window.location.href = `deskripsi_teks_lanjut.php?id_pegawai=${idPegawai}&key=${encodeURIComponent(userKey)}`;
        }
    }
    </script>
  </body>
