...
$query = "SELECT id_pegawai, nama FROM gambar";
$result = mysqli_query($konek, $query);

if (isset($_GET['plaintext'])) {
    echo htmlspecialchars($_GET['plaintext']);
}
      ...
      <div id="layoutSidenav_content">
        <main>
          <div class="container-fluid px-4">
            <h1 class="mt-4">Deskripsi Gambar</h1>
            <ol class="breadcrumb mb-4">
              <li class="breadcrumb-item">
                <a href="dashboard.php">Dashboard</a>
              </li>
              <li class="breadcrumb-item active">Deskripsi Gambar</li>
            </ol>
            <div class="card mb-4">
              ...
              <div class="card-body">
                <form action="../php/deskripsi_gambar_process.php" method="post" enctype="multipart/form-data">
                <div class="row mb-3">
                  ...
                  <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                        <textarea class="form-control" id="plaintext" name="plaintext" rows="3" readonly>
                          <?php
                              if (isset($_GET['plaintext'])) {
                                  echo htmlspecialchars($_GET['plaintext']);
                              }
                    ...
                    <?php
                      ...
                      if (isset($_GET['success']) && $_GET['success'] == 'true') {
                          ...
                          echo "<div class='alert alert-success'>Images has been decrypted. <a href='$downloadLink' class='btn btn-primary' download>Download Decrypted Images</a></div>";
                      }
                      ?>
