...
$query = "SELECT id_pegawai, nama FROM file";
      ...
      <div id="layoutSidenav_content">
        <main>
          <div class="container-fluid px-4">
            <h1 class="mt-4">Deskripsi File</h1>
            <ol class="breadcrumb mb-4">
              <li class="breadcrumb-item">
                <a href="dashboard.php">Dashboard</a>
              </li>
              <li class="breadcrumb-item active">Deskripsi File</li>
            </ol>
            <div class="card mb-4">
              ...
              <div class="card-body">
                <form action="../php/deskripsi_file_process.php" method="post" enctype="multipart/form-data">
                <div class="row mb-3">
                  ...
                  <div class="row mb-3">
                      <label for="aes_key" class="col-sm-2 col-form-label">Key</label>
                      <div class="col-sm-10">
                  ...
                  <div class="text-center">
                      <button type="submit" class="btn btn-secondary">Decript</button>
                  </div><br>
                </form>
                ...
                if (isset($_GET['success']) && $_GET['success'] == 'true') {
                    $downloadLink = $_GET['file'];
                    echo "<div class='alert alert-success'>File has been decrypted. <a href='$downloadLink' class='btn btn-primary' download>Download Decrypted File</a></div>";
                }
                ?>
              </div>
            </div>
