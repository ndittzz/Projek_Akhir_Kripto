      ...
      <div id="layoutSidenav_content">
        <main>
          <div class="container-fluid px-4">
            <h1 class="mt-4">Enkripsi  CV Pegawai</h1>
            <ol class="breadcrumb mb-4">
              <li class="breadcrumb-item">
                <a href="dashboard.php">Dashboard</a>
              </li>
              <li class="breadcrumb-item active">Enkripsi CV Pegawai</li>
            </ol>
            <div class="card mb-4">
              ...
              <div class="card-body">
                <form action="../php/enkripsi_file_process.php" method="post" enctype="multipart/form-data">
                  <!-- Drop-down untuk memilih ID - Nama pegawai -->
                  <div class="row mb-3">
                ...
                if (isset($_GET['success']) && $_GET['success'] == 'true') {
                    ...
                    echo "<div class='alert alert-success'>File has been encrypted. <a href='$downloadLink' class='btn btn-primary' download>Download Encrypted File</a></div>";
                }
                ?>
              </div>
            </div>
